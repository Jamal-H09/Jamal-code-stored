...
for i in range(len(names)):
     title = expertise[i].lower()
     years = experience[i]
     if "python" in title:
         python_applicants.append(names[i])
         print("Applicants who know Python:")
         print(python_applicants)
     if "cyber security" in title and years > 5:
         cyber_experts.append(names[i])

         print("\nCyber Security applicants with > 5 years experience:")
         print(cyber_experts)
